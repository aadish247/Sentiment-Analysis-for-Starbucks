...
for drink_name in drinks_list:
    ...
    if num_comments == 0:
        # If there are no comments, skip to the next drink
        continue
...
for index, row in results_df.iterrows():
    print("Results for {}: Number of comments: {}, Percentage of positive comments: {}%, Percentage of negative comments: {}%".format(index, row['num_comments'], row['percent_positive'], row['percent_negative']))
