...
# Iterate through each drink in the list
for drink_name in drinks_list:
    ...
    # If there are no comments for this drink, skip it and move on to the next one
    if num_comments == 0:
        continue
    ...
    num_positive = np.sum(tf_predictions[:, 1] >= threshold)
    ...
    print("Percentage of positive comments for {}: {}%".format(drink_name, percent_positive))
    print("Percentage of negative comments for {}: {}%".format(drink_name, percent_negative))
